...
function setup() 
{
  var Mtest = /iphone|ipad|android/i.test(navigator.userAgent)
if (Mtest) {
  ...
  rope3 = new Rope(4,{x:canW/2,y:225});

  ground = new Ground(canW/2,canH-10,canW,20);
  blink.frameDelay = 20;
  eat.frameDelay = 20;

  bunny = createSprite(canW/2-80,canH-80,100,100);
  bunny.scale = 0.2;
